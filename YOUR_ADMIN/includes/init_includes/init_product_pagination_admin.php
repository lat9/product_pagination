...
if (!defined('PRODUCTS_PAGINATION_MAX')) {
    ...
    $db->Execute("INSERT INTO " . TABLE_CONFIGURATION . " ( configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function ) VALUES ( 'Products Pagination &mdash; Maximum Links', 'PRODUCTS_PAGINATION_MAX', '10', '<br><b>Product</b> pages: this is the maximum number of <b>product</b> links to be displayed before <em>Intermediate Links</em> are used.<br><br><b>\"Other\"</b> page listings: this is the maximum number of <b>page</b> links to be displayed before <em>Intermediate Links</em> are used.<br><br>This value should be greater than the number of <em>Intermediate Links</em>.<br><br><b>Default: 10<b><br>', $configuration_group_id, 10, now(), NULL, NULL)");

    $db->Execute("INSERT INTO " . TABLE_CONFIGURATION . " ( configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function ) VALUES ( 'Products Pagination &mdash; Intermediate Links', 'PRODUCTS_PAGINATION_MID_RANGE', '7', '<br>Intermediate Links are those shown between ellipsis. e.g 1&hellip;7 8 9&hellip;15<br>when the number of product/\"Other\" page links exceed the <em>Maximum Links</em>.<br>The first and last product/page link is always shown.<br><br>This value should be an odd number to maintain the symmetry of the display.<br><br><b>Default: 7</b><br>', $configuration_group_id, 20, now(), NULL, NULL)");
...
if (!zen_page_key_exists('configProdPagination')) {
    ...
    $messageStack->add('Admin page registered: Configuration -> Product Pagination', 'info');
}
